...
import com.interview.drone.services.DroneService;
import com.interview.drone.services.OrderService;
import com.interview.drone.services.UtilService;
...
class ReadFileTest {
	...
	void test() {
		/*
		 * List<Order> fileOrders = new ArrayList<>(); fileOrders.add(new Order("WM001",
		 * OrderService.convertStringToCoordinate("N11W5"), UtilService.setTime(5, 11,
		 * 50), DroneService.calculateTimeTaken(OrderService.convertStringToCoordinate(
